...
import { revokePackageAccess } from "@/lib/services/master-catalogue-activation-service";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    return apiSuccess(await revokePackageAccess(actor, packageId, body.companyId));
  } catch (error) {
