...
import { transitionEmailTemplateVersion } from "@/lib/services/template-governance-service";
...
export async function PATCH(request: Request, context: RouteContext) {
  try {
    ...
    const data = await transitionEmailTemplateVersion(actor, versionId, status);
