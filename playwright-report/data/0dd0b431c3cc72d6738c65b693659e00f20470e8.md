...
- Name: public-routes.spec.ts >> Anonymous Public Routes >> Contact Sales page should submit successfully
- Location: tests\e2e\public-routes.spec.ts:33:7
...
Call log:
  - waiting for locator('label:has-text("First Name") + input')
