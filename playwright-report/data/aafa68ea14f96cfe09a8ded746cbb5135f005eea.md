...
- Name: phase6-routes.spec.ts >> Phase 6 Comparison Routes Anonymous Access >> Anonymous user can access /ai-boq-vs-manual-boq-preparation directly without redirect
...
Call log:
  - navigating to "http://localhost:3000/ai-boq-vs-manual-boq-preparation", waiting until "load"
