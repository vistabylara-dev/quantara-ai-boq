...
const CATALOGUE_PRODUCTS: ProductSpec[] = [
  ...
  },
  {
    ...
    shortDescription: "Core enterprise features.",
    description: "Enterprise Core subscription.",
    purchaseMode: "DIRECT",
    sortOrder: 170,
    prices: [{ code: "enterprise_core_annual_aed_15000", amountMinor: 1500000, billingInterval: "YEAR" }],
    entitlement: { maxUsers: 50, maxWorkspaces: 20, removesWatermark: true, allowsCompanyBranding: true, allowsApiAccess: true, entitlementDurationDays: 30 },
  },
  {
    code: "enterprise_scale",
    type: "SUBSCRIPTION",
    name: "Enterprise Scale",
    shortDescription: "Scale enterprise features.",
    description: "Enterprise Scale subscription.",
    purchaseMode: "DIRECT",
    sortOrder: 180,
    prices: [{ code: "enterprise_scale_annual_aed_25000", amountMinor: 2500000, billingInterval: "YEAR" }],
    entitlement: { maxUsers: 100, maxWorkspaces: 50, removesWatermark: true, allowsCompanyBranding: true, allowsApiAccess: true, allowsWhiteLabel: true, entitlementDurationDays: 30 },
  },
  {
    code: "enterprise_authority",
    type: "SUBSCRIPTION",
    name: "Enterprise Authority",
    shortDescription: "Authority enterprise features.",
    description: "Enterprise Authority subscription.",
    purchaseMode: "DIRECT",
    sortOrder: 190,
    prices: [{ code: "enterprise_authority_annual_aed_35000", amountMinor: 3500000, billingInterval: "YEAR" }],
    entitlement: { maxUsers: null, maxWorkspaces: null, removesWatermark: true, allowsCompanyBranding: true, allowsApiAccess: true, allowsWhiteLabel: true, entitlementDurationDays: 30 },
  },
];
