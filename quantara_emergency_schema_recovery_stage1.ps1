...
$wt   = "$env:USERPROFILE\Desktop\quantara-ai-boq.schema-recovery"
$branch = "emergency/schema-recovery-20260815"
$expectedMain = "62b6814debaf9040cd1f579846a2616783edb24c"
...
const PINNED_COMMIT = "62b6814debaf9040cd1f579846a2616783edb24c";
