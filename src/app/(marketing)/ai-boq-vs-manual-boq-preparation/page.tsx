...
export const metadata = createPublicPageMetadata("/ai-boq-vs-manual-boq-preparation");
...
export default function Page() {
  return (
    <ComparisonPage 
      ...
      approachADefinition={"AI-assisted BOQ workflows can capture supported text and table information into a reviewable structure. Quantara currently works with text-based PDFs and supported spreadsheets; scanned PDFs are detected, but OCR text extraction is not available."}
      ...
      quantaraRole={"Quantara provides supported text-based PDF and spreadsheet capture within a workflow that requires manual review, correction and professional approval."}
