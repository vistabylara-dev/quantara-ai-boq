...
const content: SeoLandingPageContent = {
  ...
  h1: "BOQ Document Generation from Structured Project Data for Professional Review",
  ...
  workflowProblem: {
    ...
    paragraphs: ["Spreadsheet formatting can introduce page-break, heading, font and formula problems while teams prepare a BOQ for issue.","Hidden rows, broken formulas or inconsistent pagination can affect a commercial submission, so the final output must be checked against the stored project data and original source records."]
  },
  quantaraSupport: {
  ...
  workflowExample: {
    ...
    steps: [{"title":"Data Review","description":"The responsible professional reviews the structured BOQ data; generation itself does not enforce review completion."},{"title":"Select Template","description":"The user selects an available output template."},{"title":"Generation","description":"Quantara formats the stored data into the selected supported output."},{"title":"Verification","description":"The team checks layout, data, calculations and totals against the stored project record and source documents."},{"title":"Approval and Issue","description":"The responsible professional approves the checked files before they are issued."}]
  },
  supportedInputs: [{"name":"Structured Database","capabilityId":"boq-management","description":"Generation uses stored, structured data; draft or otherwise unreviewed records can still be present and must be checked."}],
