...
export const metadata = createPublicPageMetadata("/boq-software-dubai");
...
export default function Page() {
  const content: SeoLandingPageContent = {
    ...
    directDefinition: "Dubai fit-out and MEP workflows can involve frequent tender revisions and document exchanges. Quantara organizes supported sources and distinct BOQ revisions for professional review.",
    audience: {
    ...
    workflowProblem: {
      ...
      paragraphs: ["Fit-out projects and MEP coordination in Dubai often involve design changes and tender revisions. Loose PDF and spreadsheet exchanges can make the applicable record difficult to confirm.","A structured approach supports checking which reviewed version applies before proposal preparation."]
    },
    quantaraSupport: {
      heading: "Structured Document Exchange",
      paragraphs: ["Quantara captures supported information from text-based PDFs and spreadsheets for review, then organizes confirmed items in a hierarchical BOQ. Distinct revision records are available for professional comparison.","Estimators must still identify and interpret every change between tender versions."]
    },
    relevantFeatures: [
