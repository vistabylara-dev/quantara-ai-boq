...
export async function generateMetadata() {
  ...
  return createPublicPageMetadata("/boq-software-vs-document-management", locale);
}
...
export default function Page() {
  return (
    <ComparisonPage 
      ...
      quantaraRole={"Quantara serves as the BOQ software: it imports supported structured spreadsheets, stores extractable PDF text, creates candidates from supported detected table rows and manages professionally reviewed BOQ records alongside retained source files."}
