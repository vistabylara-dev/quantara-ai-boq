...
const content: SeoLandingPageContent = {
  ...
  supportedInputs: [{"name":"XLSX / CSV","status":"Live","description":"Direct import of existing spreadsheet data."},{"name":"Text-based PDF","status":"Live","description":"AI-assisted extraction from PDFs."},{"name":"Scanned PDF","status":"Live","description":"OCR processing for image-based documents."},{"name":"IFC","status":"Planned","description":"Model data integration.","limitation":"Capability and processing method to be confirmed after technical validation."}],
