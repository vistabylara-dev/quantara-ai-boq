...
const content: SeoLandingPageContent = {
  ...
  relevantFeatures: [{"name":"Structured Workspaces","status":"Available","description":"Maintain clear boundaries between project scope and pricing."},{"name":"BOQ Revision Records","status":"Available","description":"Keep distinct revision records for review; users interpret quantity and scope changes."},{"name":"Template Management","status":"Available","description":"Apply supported company templates to project records."}],
  workflowExample: {
    heading: "Structured Estimating Workflow",
    introduction: "How an estimating team handles a complex tender:",
    steps: [{"title":"Supported Capture","description":"Supported information from a text-based client BOQ is captured into a review queue."},{"title":"Source Verification","description":"The estimator checks captured items against the original project sources."},{"title":"Pricing Inputs","description":"The professional enters or reviews rates, assumptions and exclusions."},{"title":"Commercial Review","description":"The responsible team reviews the structured estimate and assumptions."},{"title":"Output Generation","description":"A supported PDF or XLSX output is generated from reviewed data and checked before issue."}]
  },
  supportedInputs: [{"name":"XLSX / CSV","status":"Available","description":"Import supported structured client BOQ or pricing data for review."},{"name":"Text-based PDF","status":"Available","description":"Capture supported scope candidates from consultant documents for review."},{"name":"Scanned/Image-Only PDF — Detection","status":"Limited","description":"Detects image-only tender pages and reports that text extraction is unavailable.","limitation":"Quantara does not provide OCR; manual transcription is required."},{"name":"Scanned/Image-Only PDF — OCR","status":"Not available","description":"Automated text recognition for scanned tender files is not currently implemented.","limitation":"Scanned tender files require manual transcription."},{"name":"BIM / IFC","status":"Not available","description":"Model-based quantity extraction is not currently available.","limitation":"Capability and processing method to be confirmed after technical validation."}],
  supportedOutputs: [{"name":"XLSX Export","status":"Available","description":"Structured data export for further professional processing."},{"name":"PDF Generation","status":"Available","description":"Reviewable BOQ documents generated from stored data and available templates."},{"name":"Technical Reports","status":"Available","description":"Supported reports generated from reviewed project records and templates."}],
