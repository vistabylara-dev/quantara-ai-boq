...
export default function Page() {
  return (
    <ComparisonPage 
      ...
      quantaraRole={"For text-based PDFs, Quantara provides structured BOQ extraction directly from the document's real text layer — no OCR involved — ensuring the data is organized, mapped to the right fields, and presented in a review interface. For scanned/image-only PDFs, Quantara detects and flags pages as requiring OCR today; automated OCR-based structured extraction is planned and not yet available."}
      faqs={[{"question":"Is OCR the same as BOQ extraction?","answer":"No. OCR is just the text recognition part. Extraction involves understanding the layout and structure of that text."},{"question":"Why does basic OCR fail on BOQs?","answer":"BOQs have complex layouts with merged cells, multi-line descriptions, and hierarchical headings that confuse basic text-reading algorithms."},{"question":"Does structured extraction guarantee perfect results?","answer":"No. It significantly improves structure, but human review is always required to catch edge cases and errors."},{"question":"Can I use generic OCR tools for my estimates?","answer":"You can, but you will spend a lot of time manually formatting the output to make it usable."},{"question":"What makes Quantara different from Adobe Acrobat OCR?","answer":"For text-based PDFs, Quantara reconstructs the specific table relationships needed for a Bill of Quantities directly from the real text layer. Quantara does not yet run OCR itself, so this comparison currently applies to text-based, not scanned, documents."},{"question":"Do I still need to review the document?","answer":"Yes, professional review is a mandatory step in any extraction workflow."},{"question":"Does it work on scanned PDFs?","answer":"Scanned PDFs can be uploaded and are automatically detected and flagged as requiring OCR, but automated OCR text extraction is planned and not yet available. Scanned content currently requires manual transcription."}]}
