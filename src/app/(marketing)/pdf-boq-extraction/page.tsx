...
const content: SeoLandingPageContent = {
  ...
  supportedOutputs: [{"name":"Structured Database","capabilityId":"project-workspaces","description":"Authorized project and BOQ records."},{"name":"XLSX Export","capabilityId":"professional-outputs","description":"Export stored structured data to XLSX for professional review."}],
