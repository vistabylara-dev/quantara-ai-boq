...
const content: SeoLandingPageContent = {
  ...
  directDefinition: "PDF BOQ extraction captures available text, table data, item descriptions and quantities from supported text-based PDFs into a structure that must be reviewed before commercial use.",
  audience: {
  ...
  quantaraSupport: {
    ...
    paragraphs: ["Quantara reads the available text layer and applies supported table parsing. Complex layouts, merged cells, implicit hierarchy and tables that continue across pages may require correction.","Captured information is presented within a source-review workflow. The estimator remains responsible for comparing descriptions, units and quantities with the original PDF before approving structured BOQ data."]
  },
  relevantFeatures: [{"name":"Supported Table Capture","status":"Available","description":"Capture available text and supported table structures from text-based PDFs."},{"name":"Page-by-Page PDF Processing","status":"Available","description":"Process supported content across PDF pages; table continuity and hierarchy still require review."},{"name":"Source Review","status":"Available","description":"Open source records and captured results for professional comparison and correction."}],
  workflowExample: {
    heading: "Reviewing a Longer Tender Document",
    introduction: "How an estimator handles a supported text-based tender document:",
    steps: [{"title":"Upload a Supported File","description":"The text-based PDF is added to the authorized Quantara project workspace."},{"title":"Supported Capture","description":"The system captures available text and supported table candidates."},{"title":"Review Preparation","description":"Captured candidates are presented for review; complex or merged structures may need manual reconstruction."},{"title":"Human Validation","description":"The estimator compares the result with the source and corrects misaligned items."},{"title":"BOQ Confirmation","description":"Reviewed information can then be confirmed into the structured project BOQ."}]
  },
  supportedInputs: [{"name":"Text-based PDF","status":"Available","description":"Supported digital PDFs with an existing text layer."},{"name":"Scanned/Image-Only PDF — Detection","status":"Limited","description":"Detects image-only pages and reports that text extraction is unavailable.","limitation":"Quantara does not provide OCR; manual transcription is required."},{"name":"Scanned/Image-Only PDF — OCR","status":"Not available","description":"Automated text recognition for image-based PDFs is not currently implemented.","limitation":"Scanned PDFs require manual transcription."}],
  supportedOutputs: [{"name":"Structured Database","status":"Available","description":"Authorized project and BOQ records."},{"name":"XLSX Export","status":"Available","description":"Export reviewed structured data to XLSX."}],
