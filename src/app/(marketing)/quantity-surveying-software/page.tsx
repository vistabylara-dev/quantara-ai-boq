...
const content: SeoLandingPageContent = {
  ...
  relevantFeatures: [{"name":"BOQ Revision Records","status":"Available","description":"Keep distinct revision records for professional comparison and interpretation."},{"name":"Template Control","status":"Available","description":"Apply supported company templates to BOQ records."},{"name":"Structured Workspaces","status":"Available","description":"Organize data by project and client."}],
  workflowExample: {
    heading: "Managing a Tender Variation",
    introduction: "How a Quantity Surveyor handles a mid-tender design update:",
    steps: [{"title":"Baseline Revision","description":"The QS retains the reviewed BOQ as a distinct revision record."},{"title":"Review Updated Sources","description":"Supported information from updated text-based schedules is captured for professional review."},{"title":"Commercial Analysis","description":"The QS compares the records and analyzes the cost impact of confirmed changes."},{"title":"Apply Rates","description":"The professional enters or revises rates against the reviewed items."},{"title":"Generate Report","description":"A supported technical report is generated from reviewed project records and checked before issue."}]
  },
  supportedInputs: [{"name":"Text-based PDF","status":"Available","description":"Extracting data from consultant documents."},{"name":"XLSX / CSV","status":"Available","description":"Importing pricing data or measurement schedules."},{"name":"BIM / CAD","status":"Not available","description":"Model-based quantity extraction is not currently available.","limitation":"Capability and processing method to be confirmed after technical validation."}],
  supportedOutputs: [{"name":"Reviewable PDF Documents","status":"Available","description":"Formatted BOQ documents that require checking before issue."},{"name":"XLSX Export","status":"Available","description":"Structured data export for further professional processing."},{"name":"Technical Reports","status":"Available","description":"Supported reports generated from reviewed project records and templates."}],
