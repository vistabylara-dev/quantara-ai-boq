...
export default function Page() {
  return (
    <ComparisonPage 
      ...
      faqs={[{"question":"Does Quantara perform drawing takeoff?","answer":"No. Quantara focuses on structured BOQ management and extraction. Visual measurement is not currently available."},{"question":"Do I need both types of software?","answer":"Some teams use takeoff software for measurement and BOQ or estimating software for organization and pricing. The right combination depends on source formats, project controls and the selected products."},{"question":"Can I import takeoff data into BOQ software?","answer":"CSV or XLSX exchange may be available depending on both products. Quantara supports reviewed CSV and XLSX import, subject to file structure and mapping."},{"question":"What is the difference between a takeoff and a BOQ?","answer":"A takeoff is the process of determining the quantities. A BOQ is the formal document listing those quantities alongside descriptions and (eventually) rates."},{"question":"Is BIM takeoff replacing this?","answer":"BIM can support model-based measurement, while structured BOQ tools can organize reviewed quantities and commercial records. Capability varies by product and configuration."},{"question":"Who uses takeoff software?","answer":"Estimators and quantity surveyors perform takeoffs to build their estimates."},{"question":"Why keep them separate?","answer":"They are different disciplines. Measurement is geometric; BOQ management is commercial and contractual."}]}
