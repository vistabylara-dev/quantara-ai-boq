...
const content: SeoLandingPageContent = {
  ...
  relevantFeatures: [{"name":"Scanned/Image-Only Detection","status":"Limited","description":"Detects image-only pages and reports that text extraction is unavailable."},{"name":"OCR Text Recognition","status":"Not available","description":"Automated conversion of image-based text into selectable digital data is not currently available."},{"name":"Manual Review Requirement","status":"Available","description":"All manually entered data requires professional review before commercial use."}],
  workflowExample: {
  ...
  supportedInputs: [{"name":"Scanned/Image-Only PDF — Detection","status":"Limited","description":"Detects image-only pages and reports that text extraction is unavailable.","limitation":"Quantara does not provide OCR; manual transcription is required."},{"name":"Scanned/Image-Only PDF — OCR","status":"Not available","description":"Automated text recognition for scanned pages is not currently implemented.","limitation":"Scanned content requires manual transcription."},{"name":"Text-based PDF","status":"Available","description":"Supported digital PDFs with an existing text layer."}],
  supportedOutputs: [{"name":"Structured Database","status":"Available","description":"Authorized project storage for reviewed records."},{"name":"XLSX Export","status":"Available","description":"Export reviewed tabular data to XLSX."}],
