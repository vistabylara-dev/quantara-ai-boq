...
const content: SeoLandingPageContent = {
  ...
  supportedOutputs: [{"name":"Structured Database","capabilityId":"project-workspaces","description":"Authorized project storage for records subject to review."},{"name":"XLSX Export","capabilityId":"professional-outputs","description":"Export stored tabular data to XLSX for professional review."}],
