...
import { rejectFurnitureCandidate } from "@/lib/services/furniture-review-service";
import {
...
async function POSTHandler(request: Request, context: RouteContext) {
  try {
    ...
    return apiSuccess(await rejectFurnitureCandidate(actor, projectId, candidateId, body.reason));
  } catch (error) {
