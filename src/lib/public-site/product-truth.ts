...
const PUBLIC_CAPABILITY_DEFINITIONS = [
  ...
  },
  {
    ...
    status: "AVAILABLE",
    summary: "Generate supported BOQ documents and project outputs from stored BOQ and project data for professional review.",
    limitation: "Generated documents can contain draft or otherwise unreviewed records; they are not professional approval and must be checked before issue.",
  },
  {
    id: "document-templates",
    name: "Document templates",
    status: "AVAILABLE",
    summary: "Apply supported document templates to stored BOQ records and project data.",
    limitation: "Templates can be applied before professional review; configuration and every generated result require project-specific checking before reliance.",
  },
  {
    id: "technical-report-generation",
    name: "Technical report generation",
    status: "LIMITED",
    summary: "Generate DOCX technical reports from stored project records and templates in supported configured environments.",
    limitation: "Reports can contain unreviewed records and require professional checking; durable production storage must be confirmed during Controlled Early Access, and other technical-report formats and voice or typed AI editing are not currently supported.",
  },
  {
  ...
  },
  {
    ...
    name: "Commercial access review",
    status: "CONTROLLED_ACCESS",
    summary: "Review workflow fit, access scope and commercial terms through a requirements discussion during Controlled Early Access.",
    limitation: "This is an access-review process, not an activated billing or subscription capability.",
  },
  {
    id: "self-service-billing",
    name: "Self-service checkout and billing",
    status: "NOT_AVAILABLE",
    summary: "Quantara does not currently offer public checkout, subscription activation, payment-webhook activation or a customer billing portal.",
  },
  {
