    ...
    "@graph": [
      {
        ...
        name: "Vista By Lara",
        legalName: "Vista By Lara, operated under eunoia co. for Online Selling",
      ...
      },
      {
        ...
        url: `${PUBLIC_SITE_ORIGIN}/`,
        name: "Quantara AI BOQ by Vista By Lara",
        alternateName: ["Quantara", "Quantara AI BOQ"],
      ...
      },
      {
        ...
        alternateName: "Quantara by Vista By Lara",
        url: `${PUBLIC_SITE_ORIGIN}/`,
        ...
        availableLanguage: ["English", "Arabic"],
        featureList: [
          "Drawing-to-BOQ quantity takeoff",
          "Quantity-complete unpriced BOQ generation",
          "Construction, fit-out, furniture, MEP, electrical, HVAC, plumbing, firefighting, joinery and landscaping workflows",
          "Quantity calculation evidence and drawing provenance",
          "Assumptions, exclusions, unresolved evidence and confidence records",
          "Engineer-controlled rates, revisions and locking",
          "BOQ, proposal, technical report, spreadsheet and HTML outputs",
          "Signed voice proposals for BOQ item changes",
        ],
        audience: {
          "@type": "BusinessAudience",
          audienceType: "Quantity surveyors, estimators, contractors, consultants and specialist trade teams",
        },
        publisher: { "@id": PUBLIC_ENTITY_IDS.organization },
