  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        availableLanguage: ["English", "Arabic"],
        featureList: [
          "AI-assisted BOQ preparation",
          "Complete engineer-controlled BOQ creation and editing",
          "Guided quantity measurement",
          "Visible deterministic calculations",
          "Professional rate and commercial control",
          "BOQ revisions and validation",
          "Industry-specific construction libraries",
          "Professional BOQ document outputs",
        ],
        audience: {
