...
export const PUBLIC_SEARCH_PAGES = [
  page({ path: "/", title: "BOQ Measurement & Quantity Calculation Software UAE | Quantara", description: "Guided BOQ measurement software for reviewed sources, deterministic quantity calculations, visible engineering formulas, voice-assisted input and professional confirmation.", cluster: "core", intent: "commercial", priority: 1, changeFrequency: "weekly" }),
  ...
  page({ path: "/ai-boq-software", title: "AI BOQ Measurement & Quantity Calculation Software | Quantara", description: "Use guided construction measurement, deterministic quantity calculations, voice-assisted BOQ input and supported Autodesk DWG analysis within a review-led workflow.", cluster: "core", intent: "commercial" }),
