...
export const PUBLIC_SEARCH_PAGES = [
  ...
  page({ path: "/features", title: "AI BOQ Software Features & Engineer Control | Quantara", description: "Combine AI Draft BOQ with direct item creation, guided measurement, visible formulas, rates, revisions, industry libraries, TAYQAN and professional outputs.", cluster: "core", intent: "commercial", priority: 0.95, changeFrequency: "weekly" }),
  ...
  page({ path: "/boq-software", title: "Professional BOQ Software for Construction Teams | Quantara", description: "Create complete BOQs with AI assistance and full professional controls for items, quantities, units, rates, calculations, revisions, validation and outputs.", cluster: "core", intent: "commercial" }),
  ...
  page({ path: "/industries", title: "Industry-Specific BOQ Software | Quantara", description: "Create professional BOQs for contractors, QS, MEP, HVAC, fit-out, fire protection, FM and consultants using specialist libraries and engineer-controlled workflows.", cluster: "audience", intent: "commercial" }),
  ...
  page({ path: "/boq-software-for-engineering-consultants", title: "BOQ Software for Engineering Consultants | Quantara", description: "Prepare and review consultant BOQs with structured sources, professional engineering input, visible calculations, controlled revisions and client-ready outputs.", cluster: "audience", intent: "commercial" }),
  page({ path: "/gcc-boq-software", title: "BOQ Software for GCC Construction Teams | Quantara", description: "Create professional GCC project BOQs with AI-assisted preparation, engineer-controlled workflows, industry libraries, visible calculations, rates and revisions.", cluster: "regional", intent: "commercial" }),
