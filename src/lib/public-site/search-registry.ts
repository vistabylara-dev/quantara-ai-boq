...
export const PUBLIC_SEARCH_PAGES = [
  ...
  page({ path: "/ai-boq-software", title: "AI BOQ Generator from Drawings | Quantara", description: "Select an industry, upload drawings and generate a quantity-complete unpriced BOQ with formulas, evidence, assumptions and engineer review.", cluster: "core", intent: "commercial", priority: 0.98, changeFrequency: "weekly" }),
  ...
  page({ path: "/quantity-takeoff-vs-boq-software", title: "Takeoff Software Comparison: Quantara, Togal, Kreo & CostX", description: "Compare Quantara with Togal.AI, Kreo and RIB CostX for drawing takeoff, estimating, unpriced BOQ generation, evidence, revisions and professional outputs.", cluster: "comparison", intent: "commercial" }),
  page({ path: "/quantara-vs-togal-ai", title: "Quantara vs Togal.AI: Takeoff Software Comparison", description: "Compare Quantara and Togal.AI for drawing takeoff, quantity evidence, unpriced BOQ preparation, revisions, pricing control and deliverables.", cluster: "comparison", intent: "commercial", priority: 0.9, changeFrequency: "monthly" }),
  page({ path: "/quantara-vs-kreo", title: "Quantara vs Kreo: AI Takeoff Software Comparison", description: "Compare Quantara and Kreo for AI-assisted takeoff, structured unpriced BOQs, calculation evidence, rates, revisions and project outputs.", cluster: "comparison", intent: "commercial", priority: 0.9, changeFrequency: "monthly" }),
  page({ path: "/quantara-vs-costx", title: "Quantara vs RIB CostX: BOQ Software Comparison", description: "Compare Quantara and RIB CostX for 2D and BIM takeoff, estimating, unpriced BOQs, evidence, revision control and professional review.", cluster: "comparison", intent: "commercial", priority: 0.9, changeFrequency: "monthly" }),
  page({ path: "/quantara-vs-autodesk-takeoff", title: "Quantara vs Autodesk Takeoff: Software Comparison", description: "Compare Quantara and Autodesk Takeoff for drawing measurement, model-based quantities, unpriced BOQs, evidence, collaboration and outputs.", cluster: "comparison", intent: "commercial", priority: 0.9, changeFrequency: "monthly" }),
