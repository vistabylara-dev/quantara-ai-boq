...
export const PUBLIC_SEARCH_PAGES = [
  ...
  page({ path: "/boq-document-generation", title: "BOQ Document Generation from Stored Data | Quantara", description: "Generate supported BOQ documents from stored project records for professional review; draft or unreviewed data must be checked before issue.", cluster: "core", intent: "commercial" }),
