...
- Name: edge-cases.spec.ts >> Edge Cases & Resiliency >> should reject invalid file types
- Location: tests\e2e\edge-cases.spec.ts:68:7
...
→ 18 await prisma.company.create({
       data: {
         id: "9582dd91-fa49-49b4-9457-c2bc765403c2",
