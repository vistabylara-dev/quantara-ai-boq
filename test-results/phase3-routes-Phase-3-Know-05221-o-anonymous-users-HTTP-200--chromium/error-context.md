...
- Name: phase3-routes.spec.ts >> Phase 3 Knowledge Base Routes Public Access >> Route /how-to-review-ai-extracted-boq should be accessible to anonymous users (HTTP 200)
